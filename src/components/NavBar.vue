    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="h-12 mr-3" viewBox="0 0 48 48">
                    <path fill="#f5bc00" d="M44,41H4V10h40V41z"></path>
                    <polygon fill="#eb7900" points="44,26 24,26 4,26 4,10 44,10"></polygon>
                    <path fill="#eb7900" d="M17,26h-6v3h6V26z"></path>
                    <path fill="#eb7900" d="M37,26h-6v3h6V26z"></path>
                    <rect width="14" height="3" x="17" y="7" fill="#f5bc00"></rect>
                    <path fill="#eb0000" d="M17,23h-6v3h6V23z"></path>
                    <path fill="#eb0000" d="M37,23h-6v3h6V23z"></path>
                </svg>
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Amarnath C</span>
            </a>
                ...
                <ul
                    ...
                    <li>
                        ...
                        <div id="dropdownNavbar"
                            ...
                            <div class="py-1">
                                <a href="#"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">-</a>
                            </div>
                        </div>
                </li>
                <li>
